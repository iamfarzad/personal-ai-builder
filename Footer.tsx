      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            ...
            >
              Empowering individuals and businesses to build custom AI systems tailored to their specific needs.
            </motion.p>
            <motion.div 
          ...
          <div>
            ...
            >
              ...
              <li><a href="#" className="text-muted-foreground hover:text-foreground transition-colors">API References</a></li>
