...
const PlatformsBanner = () => {
  return (
    <div className="w-full py-10 md:py-14 bg-gradient-to-r from-purple-50 via-blue-50 to-purple-50 dark:from-indigo-950/20 dark:via-blue-950/10 dark:to-indigo-950/20">
